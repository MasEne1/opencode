...
export const dict = {
  ...
  "sidebar.settings": "设置",
  "sidebar.fork.task.new": "新建任务",
  "sidebar.fork.menu.search": "搜索",
  "sidebar.fork.tab.projects": "项目",
  "sidebar.fork.tab.groups": "分组",
  "sidebar.fork.group.today": "今天",
  "sidebar.fork.group.yesterday": "昨天",
  "sidebar.fork.group.week": "近 7 天",
  "sidebar.fork.group.older": "更早",
  "sidebar.fork.settings": "设置",
  "sidebar.help": "帮助",
